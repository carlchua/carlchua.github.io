        ...
        <section className="intro-section" data-section="intro">
            <div className="intro-content">
                ...
                <p className="intro-description">
                    ...
                    not on my computer, I like to snowboard, play guitar/sax,
                    and try out new restaurants around the bay (please let me
                    know if you have recs for a good Malaysian restaurant).
                </p>
