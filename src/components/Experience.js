      ...
      <div className="section-content">
        <div className="section-item">
          ...
          <ul className="description">
            <li>Implemented Retrieval-Augmented Generation (RAG) pipelines. Processed and cleaned data to enhance synthetic data generation for fine-tuning embedding models, speeding up training by 15%</li>
        ...
        <div className="section-item">
          <h3 className="sub-title">ML Engineer</h3>
